...
date: 2020-10-21
tags: [R, data science, api]
header:
    image: "/images/posts/2020-10-21/spotify.jpg"
excerpt: "R, Spotify, Data Science, API"
---
...
track_num_artist <-
  ...
  top_n(20, n)
```
![](https://github.com/ferdcoz/spotify-r/blob/main/spotifyr_artists.png)<!-- -->
...
```
![](https://github.com/ferdcoz/spotify-r/blob/main/spotifyr_artists_bars.png)<!-- -->
...
![](https://github.com/ferdcoz/spotify-r/blob/main/spotifyr_artists_valence.png)<!-- -->
